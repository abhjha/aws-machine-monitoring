...
export class AlertDetail extends React.Component {
            ...
            <div className="popupContainer">
                ...
                <div className="sections">
                    ...
                    <div className="rightSection">
                            <ul>
                                <li><p className="title">Location:</p><p className="content">{tmp.alertInfo[3]}</p></li>
                                <li><p className="title">Date:</p><p className="content">{(tmp.alertInfo[4])[0]}</p></li>
                                <li><p className="title">Time:</p><p className="content">{(tmp.alertInfo[4])[1]}</p></li>
                            </ul>
                    </div>
                </div>
