            ...
            <div className="data-container setpoint-view">
                ...
                <div className="setpoint-heading card-tile">
                    ...
                    <div className="setpoint-details">
                        Insight: When ambient conditions exceed analytics-defined thresholds, setpoints should be adjusted optimize the process and reduce scrap based on machine learning models
                  </div>
                </div>
